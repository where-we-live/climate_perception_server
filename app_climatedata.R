...
# Combine all three server blocks here — previously added Climate Data + newly restored tabs 1 and 2
# Use the updated server logic you had for Climate Data, and the re-added logic for Maps and Comparison
